...
export function badgeSvg({ name, course, degree, progress, img }) {
  return `
    <svg xmlns="http://www.w3.org/2000/svg" width="410" height="173" >
      ...
      <!-- Texto -->
      <text x="160" y="125" font-family="Poppins, sans-serif" font-size="10" fill="#333">
        CONCLUSÃO:
      </text>
      <text x="375" y="125" font-family="Poppins, sans-serif" font-size="10" fill="#333" text-anchor="end">
        ${progress}
      </text>
     ...
     <!-- Barra de progresso -->
     <rect x="160" y="135" width="200" height="5" fill="#4CAF50" rx="2.5" ry="2.5" />
     </svg>
  `;
}
